...
export class RoutedAgent extends BaseAgent {
	...
	/** Query the same per-turn route used for execution when reporting usage. */
	usesAcp(model?: ModelId): boolean { return this.route(model ?? this.defaultModel) instanceof AcpAgent; }
