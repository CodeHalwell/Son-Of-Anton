 ...
 * the in-memory fake used in tests. Re-exported from `../host` for backward
 * compatibility with the original auth module surface.
 */
export type { SecretStore } from '../host';
