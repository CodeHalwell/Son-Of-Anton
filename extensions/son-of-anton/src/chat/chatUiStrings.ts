...
export function getChatUiStrings(): Record<string, string> {
	return {
		...
		bundledModelGroup: vscode.l10n.t('Bundled Defaults · {0}'),
		localModelCatalog: vscode.l10n.t('Models Found Locally: {0}'),
		localModelCatalogSource: vscode.l10n.t('Source: {0} · Updated: {1}'),
		localModelsNeedAdapter: vscode.l10n.t('Local model inventory. Configure an ACP adapter to negotiate execution access.'),
