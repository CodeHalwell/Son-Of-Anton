...
import { RoutedAgent } from 'son-of-anton-core/agents/RoutedAgent';
...
export class AgentBridge {
	...
	isAcpAgent(specialistId: string, model?: ModelId): boolean {
		const agent = this.stack.specialists.get(specialistId as AgentHandle);
		return agent instanceof AcpAgent || (agent instanceof RoutedAgent && agent.usesAcp(model));
	}
