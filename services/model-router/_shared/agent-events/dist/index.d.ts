 ...
 */
export type AgentEvent = MessageStartEvent | TextDeltaEvent | ToolUseStartEvent | ToolUseDeltaEvent | ToolUseStopEvent | ThinkingDeltaEvent | UsageEvent | MessageStopEvent | ErrorEvent;
...
export declare function isMessageStart(event: AgentEvent): event is MessageStartEvent;
export declare function isTextDelta(event: AgentEvent): event is TextDeltaEvent;
export declare function isToolUseStart(event: AgentEvent): event is ToolUseStartEvent;
export declare function isToolUseDelta(event: AgentEvent): event is ToolUseDeltaEvent;
export declare function isToolUseStop(event: AgentEvent): event is ToolUseStopEvent;
export declare function isThinkingDelta(event: AgentEvent): event is ThinkingDeltaEvent;
export declare function isUsage(event: AgentEvent): event is UsageEvent;
export declare function isMessageStop(event: AgentEvent): event is MessageStopEvent;
export declare function isError(event: AgentEvent): event is ErrorEvent;
/**
 ...
 */
export declare function isTerminal(event: AgentEvent): event is MessageStopEvent | ErrorEvent;
/**
 ...
 */
export declare function emptyUsage(): UsageEvent;
export declare function addUsage(a: UsageEvent, b: UsageEvent): UsageEvent;
