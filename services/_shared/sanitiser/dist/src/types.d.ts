...
export type ContextSourceType = 'system-prompt' | 'project-config' | 'source-code' | 'documentation' | 'dependency' | 'mcp-tool-description' | 'mcp-tool-response' | 'user-message' | 'external-content' | 'extension-context';
