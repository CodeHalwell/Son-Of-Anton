...
exports.ContextSanitiser = void 0;
const injectionPatterns_1 = require("./patterns/injectionPatterns");
const trustResolver_1 = require("./trust/trustResolver");
/**
...
class ContextSanitiser {
     ...
     */
    sanitise(input, source) {
        const trustLevel = (0, trustResolver_1.resolveTrustLevel)(source);
        ...
        for (const pattern of injectionPatterns_1.INJECTION_PATTERNS) {
            ...
            if (!(0, trustResolver_1.appliesAtTrustLevel)(trustLevel, pattern.minTrustLevel)) {
                continue;
            }
        ...
        const unicodePattern = injectionPatterns_1.INJECTION_PATTERNS.find(p => p.id === 'invisible-unicode');
        if (unicodePattern && (0, trustResolver_1.appliesAtTrustLevel)(trustLevel, unicodePattern.minTrustLevel)) {
     ...
     */
    reviewMcpTools(serverName, tools) {
        const entries = [];
     ...
     */
    static getSecurityPromptAddition() {
        return [
...
exports.ContextSanitiser = ContextSanitiser;
