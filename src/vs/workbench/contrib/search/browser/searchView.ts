...
export class SearchView extends ViewPane {
	...
	protected override renderBody(parent: HTMLElement): void {
		...
		this.toggleQueryDetailsButton = dom.append(this.queryDetails,
			$('.more' + ThemeIcon.asCSSSelector(searchDetailsIcon), { tabindex: 0, role: 'button', 'aria-label': toggleQueryDetailsLabel, 'aria-expanded': String(!!this.viewletState.query?.queryDetailsExpanded) }));
