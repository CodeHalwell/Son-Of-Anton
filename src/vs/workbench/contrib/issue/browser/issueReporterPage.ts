	...
	<div class="system-info" id="block-container">
		<div class="block block-extension-data">
			...
			<label class="extension-caption" id="extension-caption" for="includeExtensionData">
				...
				<span class="ext-parens" hidden>(</span><a href="#" class="showInfo" role="button" aria-expanded="false" tabIndex=0 id="extension-id" aria-label="${escape(localize('showExtensionData', "Toggle Extension Data"))}">${escape(localize('show', "show"))}</a><span class="ext-parens" hidden>)</span>
		...
		<div class="block block-system">
			...
			<label class="caption" for="includeSystemInfo">
				${sendSystemInfoLabel}
				(<a href="#" class="showInfo" role="button" aria-expanded="false" tabIndex=0 aria-label="${escape(localize('showSystemInfo', "Toggle System Info"))}">${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-process">
			...
			<label class="caption" for="includeProcessInfo">
				...
				(<a href="#" class="showInfo" role="button" aria-expanded="false" tabIndex=0 aria-label="${escape(localize('showProcessInfo', "Toggle Process Info"))}">${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-workspace">
			...
			<label class="caption" for="includeWorkspaceInfo">
				...
				(<a href="#" class="showInfo" role="button" aria-expanded="false" tabIndex=0 aria-label="${escape(localize('showWorkspaceInfo', "Toggle Workspace Info"))}">${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-extensions">
			...
			<label class="caption" for="includeExtensions">
				${sendExtensionsLabel}
				(<a href="#" class="showInfo" role="button" aria-expanded="false" tabIndex=0 aria-label="${escape(localize('showExtensions', "Toggle Extensions"))}">${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-experiments">
			...
			<label class="caption" for="includeExperiments">
				...
				(<a href="#" class="showInfo" role="button" aria-expanded="false" tabIndex=0 aria-label="${escape(localize('showExperiments', "Toggle Experiments"))}">${escape(localize('show', "show"))}</a>)
			</label>
			<pre class="block-info hidden" style="user-select: text;">
				<!-- To be dynamically filled -->
			</pre>
