	...
	<div class="system-info" id="block-container">
		<div class="block block-extension-data">
			...
			<label class="extension-caption" id="extension-caption" for="includeExtensionData">
				...
				<span class="ext-parens" hidden>(</span><a href="#" class="showInfo" role="button" tabIndex=0 id="extension-id">${escape(localize('show', "show"))}</a><span class="ext-parens" hidden>)</span>
		...
		<div class="block block-system">
			...
			<label class="caption" for="includeSystemInfo">
				${sendSystemInfoLabel}
				(<a href="#" class="showInfo" role="button" tabIndex=0>${escape(localize('show', "show"))}</a>)
			</label>
