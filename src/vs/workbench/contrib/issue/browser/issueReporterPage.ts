	...
	<div class="system-info" id="block-container">
		<div class="block block-extension-data">
			...
			<label class="extension-caption" id="extension-caption" for="includeExtensionData">
				...
				<span class="ext-parens" hidden>(</span><a href="#" class="showInfo" role="button" aria-expanded="false" aria-label="${toggleExtensionDataLabel}" tabIndex=0 id="extension-id">${escape(localize('show', "show"))}</a><span class="ext-parens" hidden>)</span>
		...
		<div class="block block-system">
			...
			<label class="caption" for="includeSystemInfo">
				${sendSystemInfoLabel}
				(<a href="#" class="showInfo" role="button" aria-expanded="false" aria-label="${toggleSystemInfoLabel}" tabIndex=0>${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-process">
			...
			<label class="caption" for="includeProcessInfo">
				...
				(<a href="#" class="showInfo" role="button" aria-expanded="false" aria-label="${toggleProcessInfoLabel}" tabIndex=0>${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-workspace">
			...
			<label class="caption" for="includeWorkspaceInfo">
				...
				(<a href="#" class="showInfo" role="button" aria-expanded="false" aria-label="${toggleWorkspaceInfoLabel}" tabIndex=0>${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-extensions">
			...
			<label class="caption" for="includeExtensions">
				${sendExtensionsLabel}
				(<a href="#" class="showInfo" role="button" aria-expanded="false" aria-label="${toggleExtensionsLabel}" tabIndex=0>${escape(localize('show', "show"))}</a>)
			</label>
		...
		<div class="block block-experiments">
			...
			<label class="caption" for="includeExperiments">
				...
				(<a href="#" class="showInfo" role="button" aria-expanded="false" aria-label="${toggleExperimentsLabel}" tabIndex=0>${escape(localize('show', "show"))}</a>)
			</label>
			<pre class="block-info hidden" style="user-select: text;">
				<!-- To be dynamically filled -->
			</pre>
